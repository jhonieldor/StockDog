...
angular.module('stockDogApp')
  .controller('WatchlistCtrl', function ($scope, $routeParams, $modal,
    ...
    $scope.indexCompany = function(){
      if(angular.isObject($scope.newStock.company)){
        $scope.companySelected = $scope.newStock.company;
      }
    ...
    $scope.addStock = function () {
      $scope.newStock.company = $scope.companySelected;
